...
test('Navigating to/from year views', function(){
    var target;
...
test('Navigating to/from decade views', function(){
    var target;
...
test('Navigating prev/next in year views', function(){
    var target;
...
test('Navigating prev/next in decade views', function(){
    var target;
