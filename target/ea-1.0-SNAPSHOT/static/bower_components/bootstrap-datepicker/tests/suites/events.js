...
test('Selecting a year from decade views triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month views triggers changeYear', function(){
    var target,
        triggered = 0;
...
test('Selecting a month from year views triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Navigating forward/backward from month views triggers changeMonth', function(){
    var target,
        triggered = 0;
...
test('Clear button: triggers change and changeDate events', function(){
    ...
    this.input.focus();
    ok(this.picker.find('.datepicker-days').is(':visible'), 'Days views visible');
...
test('Changing views mode triggers changeViewMode', function () {
  var viewMode = -1,
    triggered = 0;
