...
test('Startview: year views (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days views hidden');
    ok(picker.find('.datepicker-months').is(':visible'), 'Months views visible');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years views hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades views hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries views hidden');
});

test('Startview: year views (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: decade views (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':not(:visible)'), 'Days views hidden');
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months views hidden');
    ok(picker.find('.datepicker-years').is(':visible'), 'Years views visible');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades views hidden');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries views hidden');
});

test('Startview: decade views (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: century views (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-months').is(':not(:visible)'), 'Months views hidden');
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years views hidden');
    ok(picker.find('.datepicker-decades').is(':visible'), 'Decades views visible');
    ok(picker.find('.datepicker-centuries').is(':not(:visible)'), 'Centuries views hidden');
});

test('Startview: century views (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Startview: millennium views (integer)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
    ...
    ok(picker.find('.datepicker-years').is(':not(:visible)'), 'Years views hidden');
    ok(picker.find('.datepicker-decades').is(':not(:visible)'), 'Decades views hidden');
    ok(picker.find('.datepicker-centuries').is(':visible'), 'Centuries views visible');
});

test('Startview: millennium views (string)', function(){
    var input = $('<input />')
                .appendTo('#qunit-fixture')
                .val('2012-03-05')
                .datepicker({
...
test('Today Button: today button not default', function(){
    ...
    input.focus();
    ok(picker.find('.datepicker-days').is(':visible'), 'Days views visible');
...
test('Today Button: moves to days views', function(){
...
test('Startview: year views visible after date pick', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                startView: 2,
...
test('Week Days: Week days default visibility (or enabled)', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length > 0, 'Week days added to views');
});
test('Week Days: Week days visibility when disabled', function(){
    ...
    input.focus();
    ok(picker.find('.dow').length === 0, 'Week days not added to views');
});
