...
Fired when the *views* month is changed from year views.


changeYear
----------

Fired when the *views* year is changed from decade views.


changeDecade
------------

Fired when the *views* decade is changed from century views.


changeCentury
-------------

Fired when the *views* century is changed from millennium views.
